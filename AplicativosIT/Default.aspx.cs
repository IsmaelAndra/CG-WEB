...
namespace AplicativosIT
{
    ...
    private ArrayList CreateData()
        ...
        protected void ComboBox_Selecting(object sender, SqlDataSourceSelectingEventArgs e)
        {

        }

        protected void ComboBox1_Selecting(object sender, SqlDataSourceSelectingEventArgs e)
        {
