<%@ Page Title="LOGIN" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="AplicativosIT._Login" %>
                    ...
                    <table cellpadding="0" class="Cuadrito" style="margin-left: 20px; margin-right: 20px; margin-top: 10px; margin-bottom: 10px;">
                        ...
                        <tr>
                            <td align="center" colspan="2" style="padding: 6px;" class="auto-style2">
                                <asp:Button runat="server" ID="ingresar" CssClass="btn_Ingresar" Text="Ingresar" OnClick="Login" />
